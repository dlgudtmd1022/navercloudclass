...
public class MethodExamlple2 {
	...
	public static void main(String[] args) {
		...
		//System.out.println(greet("이형승"));
		getThaiNumber();
		//System.out.println(geThaiNumber());
