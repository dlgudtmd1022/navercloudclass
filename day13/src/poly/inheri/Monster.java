...
public class Monster {
	...
	// 부모쪽 생성자를 초기화할때 어떤 몬스터가 생성될지 사전에 알 수 없음으로 
	...
	// 다음 공격에 몬스터가 죽는지 판단
	public boolean isInactiveAfterNextAttacked(int Atk) {
		return this.hp - Atk <= 0 ? true : false ;
	}
	...
	public void  setAfterAttackedHp(int userAtk) {
		...
		System.out.println("남은 " + this.name + "의 체력 : " + this.getHp());
	}
}
