...
public class ArraysEqualsTest {
	...
	public static void main(String[] args) {
		// 배열은 참조형 변수이기 때문에, 단순 대입 시 문제가 발생합니다.
		int [] intArray1 = {1, 2, 3, 4, 5};
		System.out.println("배열 주소 : " + intArray1);
		System.out.println(Arrays.toString(intArray1));
		System.out.println("--------------------------------");
		// 새로 생성하지 않고,intArray1을 대입받는 intArray2
		// 단순 대입으로 주소를 복사하는 경우를 얕은복사라고 합니다.
		// int [] intArray2 = intArray1; // intArray1 = 주소지를 가지고 있음
		
		// 단순 대입으로 스택에서 주소값만 복사하는게 아닌 
		// 힙으 자료를 새로 똑같이 할당하는 복사를 깊은복사라고 합니다.
		// 변수 뒤에 .clone()을 사용하여 수행합니다.
